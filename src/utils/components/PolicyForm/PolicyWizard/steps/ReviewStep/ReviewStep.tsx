...
const ReviewStep: FC<ReviewStepProps> = ({ policy, creationError, setPolicy }) => {
  ...
  const portNames = getPortNames(policy);
      ...
      >
        <Stack>
          <StackItem>
            ...
            >
              ...
              <DetailItem
                ...
                description={getInterfaceName(policy) || NO_DATA_DASH}
              />
          ...
          <StackItem>
            ...
            <Checkbox
              label={t('Create new Virtual Machine Network using this Node Network Mapping')}
