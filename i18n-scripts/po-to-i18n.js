...
function processFile(fileName, language) {
  ...
  newFilePath = path.join(__dirname, `../locales/${language}/plugin__nmstate-console-plugin.json`);
  console.log(`Saving /locales/${language}/plugin__nmstate-console-plugin.json`);
